...
public class MenuFactory {
    private static Menu createMenu(String category, List<MenuItem> menuItems) {
        return new Menu(category, menuItems);
    }

    public static Menu createBurgerMenu() {
        return createMenu("Burgers", List.of(
    ...
    public static Menu createDrinkMenu() {
        return createMenu("Drinks", List.of(
    ...
    public static Menu createDessertMenu() {
        return createMenu("Desserts", List.of(
